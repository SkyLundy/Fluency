 ...
 *
 * @param  string|int     $processWireId  ProcessWire language ID
 * @param  EngineInfoData $engineInfoData The Info object for a translation engine
 * @return string                         Storable config name
 ...
 *
 * @param string $configProperty Converts a stored config string to separate components for use
 */
