...
final class FluencyErrors
{
     ...
     */
    public const PW_FILE_TO_DEFAULT_LANGUAGE = 'PW_FILE_TO_DEFAULT_LANGUAGE';

    /**
     * Attempting to translate files to invalid target languages
     */
    public const PW_FILE_INVALID_TARGET_LANGUAGE = 'PW_FILE_INVALID_TARGET_LANGUAGE';

    /**
     * Attempting to translate content  to the same language
     */
    public const PW_FILE_SOURCE_TARGET_MATCH = 'PW_FILE_SOURCE_TARGET_MATCH';
    ...
    {
        if (!in_array($error, self::getDefinedErrors())) {
