    ...
    public static function getAll(): object
    {
        ...
        $values = json_encode([
            ...
            'languageTranslator' => [
                ...
                'sourceLanguageSelectLabel' => __('Source language:'),
            ],
            'usage' => [
            ...
            'errors' => [
                ...
                FluencyErrors::PW_FILE_TO_DEFAULT_LANGUAGE => __('Cannot translate files to default language'),
                FluencyErrors::PW_FILE_INVALID_TARGET_LANGUAGE => __('Invalid file translation target language'),
                FluencyErrors::PW_FILE_SOURCE_TARGET_MATCH => __('Attempting to translate content from/to the same language'),
            ]
        ]);
